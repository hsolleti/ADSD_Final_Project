...
class TestBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with app.app_context():
            ...
            self.student1 = User(username='test',password=generate_password_hash('test'), admin=False, student=True, enabled=True)
            ...
            self.assertEqual(u2.username, 'test')
...
class User_Student_Model(TestBase):
   ...
   # >//my-scores
    ...
    def test_check_student_check_pages(self):
        ...
        self.assertIn(b'Welcome, test!', response_Test_Topics.data)
